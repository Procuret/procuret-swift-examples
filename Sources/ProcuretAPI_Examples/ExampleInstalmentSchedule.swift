    ...
    public static let exampleJson: String = """
{
    ...
    "completed": false,
    "created": "2022-08-31 15:11:25.837711",
    "creating_agent": 1,
    "customer": {
        "entity_id": 40668472298990965,
        "legal_entity_name": "JULIA TIEN MY THI LE"
    },
    "disposition": {
        "count": 1,
        "limit": 20,
    ...
    "exchange_id": "HNHIiGUMXDY7HcW4",
    "identifier": "12345",
    "mechanism": 3,
    "payment_method": {
        "description": "Card ...4242",
        "public_id": "3Mq4TcXSXuub"
    },
    "public_id": "uiK3ihKJvYtw",
    "sum_payments": {
        "denomination": {
            "exponent": 2,
            "indexid": 1,
    ...
    "supplier": {
        "entity_id": 44821766204938799,
        "legal_entity_name": "Coffee Republic"
    },
    "total_payable": {
        "denomination": {
            "exponent": 2,
...
Making request to https://dev.procuret.com/api: /instalment-schedule|GET
